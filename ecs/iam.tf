...
# enable ecs to access to ssm (parameter store)
...
#           ],
#           "Resource" : [
#             "arn:aws:ssm:${data.aws_region.current.id}:${data.aws_caller_identity.self.account_id}:parameter${var.path_to_encryption_key}",
#             "arn:aws:ssm:${data.aws_region.current.id}:${data.aws_caller_identity.self.account_id}:parameter${var.path_to_control_plane_config}",
#             "arn:aws:ssm:${data.aws_region.current.id}:${data.aws_caller_identity.self.account_id}:parameter${var.path_to_envoy_config}",
...
# enable ecs to access config file s3
# resource "aws_iam_policy" "config_access" {
